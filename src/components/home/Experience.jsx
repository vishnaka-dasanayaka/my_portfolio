...
function Experience() {
  return (
    <div id="experience" className="w-screen h-auto py-10 bg-gray-100">
      ...
      <div className="grid items-start justify-start grid-cols-2 mx-32 mt-10">
            ...
            <h2 className="my-3 font-extrabold capitalize">
              ...
              >
                ...
                <span className="font-serif font-normal normal-case">
                  {" "}
                  is a service powered by OpenAI's advanced NLP capabilities to
                  deliver personalised and engaging support. It accurately
